...
--测试
yl.LOGONSERVER							= "192.168.0.111" --@login_ip
-- 登陆地址列表
yl.SERVER_LIST = 
{
    "192.168.0.111", --@login_ip
}
-- 当前地址索引
yl.CURRENT_INDEX = 1
...
--编译码
yl.VALIDATE 							= "33C4A2E1-F6BE-4EF4-A2B4-007B7C8DEDE3" --@compilation

--http请求链接地址
--yl.HTTP_URL								= "http://ry.webfox.com" --@http_url
--yl.HTTP_URL								= "http://ry.webfox.com" --@http_url
yl.HTTP_URL								= "http://192.168.0.111" --@http_url
