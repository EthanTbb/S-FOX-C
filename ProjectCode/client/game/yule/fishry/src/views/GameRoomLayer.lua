...
function GameRoomLayer:getTableParam()
    local table_bg = cc.Sprite:create("game/yule/fishry/res/roomlist/roomtable.png")
    ...
    return table_bg, {cc.p(30,185),cc.p(140,185),cc.p(250,185),cc.p(30,-25),cc.p(140,-25),cc.p(250,-25)}
end
